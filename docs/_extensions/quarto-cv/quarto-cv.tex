...
\moveleft.5\hoffset\centerline{
  ...
  $endif$
  $if(orcid)$
    $if(fontawesome)$\orcidlink{$orcid$} \hspace{.5 mm}$else$\emph{ORCID:}$endif$ \href{https://orcid.org/$orcid$}{\tt $orcid$} \hspace{1 mm}
  $endif$
  $if(web)$
...
\begin{minipage}[t]{0.30\textwidth}
  \centering
  \vspace{0pt}
  \raisebox{-40pt}[\dimexpr\ht\strutbox+\dp\strutbox][0pt]{\includegraphics[height=0.15\textheight,keepaspectratio]{photo.jpg}}
\end{minipage}
